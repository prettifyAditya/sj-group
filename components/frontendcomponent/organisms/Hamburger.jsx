...
import { useGetHeaderServiceQuery } from "@/store/backendSlice/generalAPISlice";

export default function Hamburger() {
  const { data: ServicesData } = useGetHeaderServiceQuery();
  ...
  const servicesArray = ServicesData?.HeaderService ?? [];
    ...
    <div className={`model ham-pop ${isHamOpen ? "is-open" : ""}`}>
      ...
      <div className="model-body">
        <div className="nav-list">
          <li>
            <Link href="/" onClick={closeHam}>
              Home
            </Link>
          </li>
          <li>
            <Link href="/about-us" onClick={closeHam}>
              About Us
            </Link>
          </li>
          {servicesArray?.length > 0 && (
            <li
            className={`hasDropdown ${activeDropdown === "what-we-do" ? "active" : ""}`}
            ...
            <div className="dropdown-menu-ham">
              <ul>
                {servicesArray.map((item, index) => (
                  <li key={index}>
                    <Link href={`/${item.ServiceNameURL}`} onClick={closeHam}>
                      {item.ServiceName}
                    </Link>
                  </li>
                ))}
          ...
          <li>
            <Link href="/social-responsibility" onClick={closeHam}>
              Social Responsibility
            </Link>
          </li>
          <li>
            <Link href="/career" onClick={closeHam}>
              Careers
            </Link>
          </li>
          <li>
            <Link href="/media" onClick={closeHam}>
              Media Corner
            </Link>
          </li>
          <li>
            <Link href="/contact-us" onClick={closeHam}>
              Contact Us
            </Link>
          </li>
        </div>
